...
// 初始化 OpenAI 客戶端，會自動讀取 Vercel 環境變數 OPENAI_API_KEY
const openai = new OpenAI(); 

// 由於強制輸出 JSON，SYSTEM PROMPT 必須做對應修改，強調只輸出 JSON。
...
// 為了最高的穩定性，建議使用 GPT-4-Turbo
const FINAL_MODEL = 'gpt-4-turbo'; 
